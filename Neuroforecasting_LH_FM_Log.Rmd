...
NAcc_onset_plot <- ggplot(AllSubs_NeuralActivation, aes(x = (AIns_dem_peak_pos), y = (All_Gross_M1_log))) +
  labs(y = "Gross M1 Log", x = "AIns DP") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_onset_plot2 <- ggplot(AllSubs_NeuralActivation, aes(x = (AIns_dem_peak_pos), y = (GoT_M1))) +
  labs(y = "Gross/Theaters M1 Log", x = "AIns DP") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_onset_plot3 <- ggplot(AllSubs_NeuralActivation, aes(x = (AIns_dem_peak_pos), y = (All_Gross_M1_rank))) +
  labs(y = "Gross M1 Rank", x = "AIns DP") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_onset_plot4 <- ggplot(AllSubs_NeuralActivation, aes(x = (AIns_dem_peak_pos), y = (GoT_M1_rank))) +
  labs(y = "Gross/Theaters M1 Rank", x = "AIns DP") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)
...
NAcc_onset_plot <- ggplot(AllSubs_NeuralActivation, aes(x = (AIns_middle), y = (All_Gross_M1_log))) +
  labs(y = "Gross M1 Log", x = "AIns middle") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_onset_plot2 <- ggplot(AllSubs_NeuralActivation, aes(x = (AIns_middle), y = (GoT_M1))) +
  labs(y = "Gross/Theaters M1 Log", x = "AIns middle") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_onset_plot3 <- ggplot(AllSubs_NeuralActivation, aes(x = (AIns_middle), y = (All_Gross_M1_rank))) +
  labs(y = "Gross M1 Rank", x = "AIns middle") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_onset_plot4 <- ggplot(AllSubs_NeuralActivation, aes(x = (AIns_middle), y = (GoT_M1_rank))) +
  labs(y = "Gross/Theaters M1 Rank", x = "AIns middle") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)
...
Dem_pos_peak_models <- modelsummary(Dem_pos_peak_list, stars=TRUE, statistic=NULL, output = "dataframe", gof_omit = "F|RMSE|Log") %>% select(-part, -statistic)
Dem_pos_peak_models

```

```{r}
ggplot(AllSubs_NeuralActivation, aes(x = (AIns_middle), y = (GrossOverTheaters_M1))) +
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)
...
Dem_pos_peak_yes_models <- modelsummary(Dem_pos_peak_yes_list, stars=TRUE, statistic=NULL, output = "dataframe", gof_omit = "F|RMSE|Log") %>% select(-part, -statistic)
...
Avg_pos_peak_models <- modelsummary(Avg_pos_peak_list, stars=TRUE, statistic=NULL, output = "dataframe", gof_omit = "F|RMSE|Log") %>% select(-part, -statistic)
Avg_pos_peak_models
```
...
Avg_pos_peak_yes_models <- modelsummary(Avg_pos_peak_yes_list, statistic=NULL, output = "dataframe", gof_omit = "F|RMSE|Log") %>% select(-part, -statistic)
...
Avg_pos_peak2_models <- modelsummary(Avg_pos_peak2_list, stars=TRUE, statistic=NULL, output = "dataframe", gof_omit = "F|RMSE|Log") %>% select(-part, -statistic)
Avg_pos_peak2_models
```

```{r}
ggplot(AllSubs_NeuralActivation, aes(x = (AIns_middle), y = (GoT_M1))) +
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)
