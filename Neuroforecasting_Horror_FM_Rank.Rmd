...
#AllSubs_NeuralActivation <- read.csv('/Users/luisalvarez/Documents/GitHub/RM_Thesis_Neuroforecasting/ProcessedData/AllSubs_NeuralActivation_Aggregate_LH.csv') #%>%
  #filter(Trailer!="uc3")

AllSubs_NeuralActivation <- read.csv('/Users/luisalvarez/Documents/GitHub/RM_Thesis_Neuroforecasting/ProcessedData/AllSubs_NeuralActivation_Aggregate_Combined_Horror_clean.csv') #%>%
  #filter(Trailer!="rh11", Trailer!="rh3")
  

ggplot(AllSubs_NeuralActivation, aes(x=(AIns_dem_peak_pos2), y=(Gross_US_M1/Theaters_US_M1))) +
  geom_point() +
...
Log_seq_models <- modelsummary(Log_seq_list, stars=TRUE, statistic=NULL, output="AggRank_seq_horror_models.docx", gof_omit = "F|RMSE|Log") #%>% select(-part, -statistic)
    #|>
...
ggplot(AllSubs_NeuralActivation, aes(x=AIns_dem_peak_pos2, y=(GoT_M1))) +
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)
...
Log_isc_models <- modelsummary(Log_isc_list, stars=TRUE, statistic=NULL, output="AggRank_ISC_horror_models.docx", gof_omit = "F|RMSE|Log") #%>% select(-part, -statistic)
Log_isc_models
```
...
Log_avg_pos_peak_models <- modelsummary(Log_avg_pos_peak_list, stars=TRUE, statistic=NULL,output="AggRank_AVG_horror_models.docx", gof_omit = "F|RMSE|Log") #%>% select(-part, -statistic)
Log_avg_pos_peak_models
```
```{r}
ggplot(AllSubs_NeuralActivation, aes(x=MPFC_avg_peak_pos, y=(GoT_M1))) +
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)
...
Log_ind_neg_peak_models <- modelsummary(Log_ind_neg_peak_list, stars=TRUE, statistic=NULL,output="AggRank_AVGy_horror_models.docx", gof_omit = "F|RMSE|Log") #%>% select(-part, -statistic)
...
Log_tra_pos_peak_models <- modelsummary(Log_tra_pos_peak_list, statistic=NULL,output="AggRank_DP_horror_models.docx", gof_omit = "F|RMSE|Log") #%>% select(-part, -statistic)
...
Log_dem_peak_pos_yes_models <- modelsummary(Log_dem_peak_pos_yes_list,stars=TRUE,statistic=NULL, output="AggRank_DPy_horror_models.docx", gof_omit = "F|RMSE|Log") 
...
Log_dem_peak_pos_yes_models <- modelsummary(Log_dem_peak_pos_yes_list,stars=TRUE,statistic=NULL, output="AggRank_AVG2_horror_models.docx", gof_omit = "F|RMSE|Log") 
#%>% select(-part, -statistic)
Log_dem_peak_pos_yes_models
```
