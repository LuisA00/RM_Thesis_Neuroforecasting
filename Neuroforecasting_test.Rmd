...
```{r, echo = FALSE}
M7 <- lm(scale(Domestic.Gross) ~ Type +  scale(Pos_arousal) + scale(Neg_arousal) + 
              #scale(W_score) +
              scale(NAcc_offset) + 
              scale(AIns_offset) + 
              scale(MPFC_offset) 
...
```{r, echo = FALSE}
M8 <- lm(scale(Domestic.Gross) ~ Type + 
...
```{r, echo = FALSE}
M9 <- lm(scale(Domestic.Gross) ~ Type +  scale(Pos_arousal) + scale(Neg_arousal) + 
              scale(W_score) +
              scale(NAcc_middle) + 
              scale(AIns_middle) + 
              scale(MPFC_middle) 
