...
## M1: Behavioral data 
```{r, echo = FALSE}
M1 <- lm(scale(Gross_US_W1_num) ~ Type 
...
```{r, echo = FALSE}
M2 <- lm(scale(Gross_US_W1_num) ~ Type 
         + scale(Pos_arousal_scaled) 
         + scale(Neg_arousal_scaled)
         + Type:scale(Pos_arousal_scaled)
         + Type:scale(Neg_arousal_scaled)
...
```{r, echo = FALSE}
M3 <- lm(scale(Gross_US_W1_num) ~ Type 
         + scale(Theaters_US_W1_num)
         + scale(Pos_arousal_scaled) 
         + scale(Neg_arousal_scaled)
         + Type:scale(Theaters_US_W1_num)
...
# M4: ISC data alone
```{r, echo = FALSE}
M4 <- lm(scale(Gross_US_W1_num) ~ Type + 
              + scale(NAcc_ISC) 
              + scale(AIns_ISC) 
              + scale(MPFC_ISC) 
              + Type:scale(NAcc_ISC) 
...
```{r, echo = FALSE}
M5 <- lm(scale(Gross_US_W1_num) ~ Type 
             + scale(Theaters_US_W1_num) 
             + scale(Pos_arousal_scaled) 
             + scale(Neg_arousal_scaled)  
             ...
             + scale(AIns_ISC) 
             + scale(MPFC_ISC) 
             + Type:scale(Theaters_US_W1_num) # For some reason, adding this interaction kills the significance of NAcc.
             + Type:scale(Pos_arousal_scaled)
             + Type:scale(Neg_arousal_scaled)
...
```{r, echo = FALSE}
M6 <- lm(scale(Gross_US_W1_num) ~ Type + 
              #+ Theaters_US_W1_num 
              + scale(NAcc_whole) 
              + scale(AIns_whole) 
              + scale(MPFC_whole) 
...
```{r, echo = FALSE}
M7 <- lm(scale(Gross_US_W1_num) ~ Type 
             + scale(Theaters_US_W1_num)
             #+ Total_weeks 
             #+ Weeks_avg_per_theater
             + scale(Pos_arousal_scaled) 
...
```{r, echo = FALSE}
M8 <- lm(scale(Gross_US_W1_num) ~ Type + 
              + scale(NAcc_onset) 
              + scale(AIns_onset) 
              + scale(MPFC_onset) 
...
```{r, echo = FALSE}
M9 <- lm(scale(Gross_US_W1_num) ~ Type 
             + scale(Theaters_US_W1_num)
             #+ Total_weeks 
             #+ Weeks_avg_per_theater
             + scale(Pos_arousal_scaled) 
...
```{r, echo = FALSE}
M10 <- lm(scale(Gross_US_W1_num) ~ Type + 
              + scale(NAcc_middle) 
              + scale(AIns_middle) 
              + scale(MPFC_middle) 
...
```{r, echo = FALSE}
M11 <- lm(scale(Gross_US_W1_num) ~ Type 
             + scale(Theaters_US_W1_num)
             #+ Total_weeks 
             #+ Weeks_avg_per_theater
             + scale(Pos_arousal_scaled) 
...
```{r, echo = FALSE}
M12 <- lm(scale(Gross_US_W1_num) ~ Type + 
              + scale(NAcc_offset) 
              + scale(AIns_offset) 
              + scale(MPFC_offset) 
...
```{r, echo = FALSE}
M13 <- lm(scale(Gross_US_W1_num) ~ Type 
             + scale(Theaters_US_W1_num)
             #+ Total_weeks 
             #+ Weeks_avg_per_theater
             + scale(Pos_arousal_scaled) 
