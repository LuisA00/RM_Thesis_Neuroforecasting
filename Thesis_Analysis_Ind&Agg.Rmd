...
```{r}
ggpairs(Individual_BothTrailers_df[, c("Type", "W_score", "NAcc_ind_peaks_pos", "AIns_ind_peaks_pos", "MPFC_ind_peaks_pos")], columns = 2:ncol(Individual_BothTrailers_df[, c("Type", "W_score", "NAcc_ind_peaks_pos", "AIns_ind_peaks_pos", "MPFC_ind_peaks_pos")]), aes(color = Type)) 
