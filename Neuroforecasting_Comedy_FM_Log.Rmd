...
```
# Is positive arousal and watch choice predicting box office? 
```{r}


ggplot(AllSubs_NeuralActivation, aes(x = W_score_scaled, y = AllSubs_NeuralActivation$Gross_US_M1/AllSubs_NeuralActivation$Theaters_US_M1)) +
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)
...
```{r}
ggplot(AllSubs_NeuralActivation, aes(x = NAcc_onset, y = rank(GoT_M1))) +
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)
...
NAcc_onset_plot <- ggplot(AllSubs_NeuralActivation, aes(x = (NAcc_dem_peak_pos_yes), y = (All_Gross_M1_log))) +
  labs(y = "Gross M1 Log", x = "NAcc DPy") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_onset_plot2 <- ggplot(AllSubs_NeuralActivation, aes(x = (NAcc_dem_peak_pos_yes), y = (GoT_M1))) +
  labs(y = "Gross/Theaters M1 Log", x = "NAcc DPy") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_onset_plot3 <- ggplot(AllSubs_NeuralActivation, aes(x = (NAcc_dem_peak_pos_yes), y = (All_Gross_M1_rank))) +
  labs(y = "Gross M1 Rank", x = "NAcc DPy") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_onset_plot4 <- ggplot(AllSubs_NeuralActivation, aes(x = (NAcc_dem_peak_pos_yes), y = (GoT_M1_rank))) +
...
MPFC_AVG_plot <- ggplot(AllSubs_NeuralActivation, aes(x = (MPFC_avg_peak_pos), y = (All_Gross_M1_log))) +
  labs(y = "Gross M1 Log", x = "MPFC AVG") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

MPFC_AVG_plot2 <- ggplot(AllSubs_NeuralActivation, aes(x = (MPFC_avg_peak_pos), y = (GoT_M1))) +
  labs(y = "Gross/Theaters M1 Log", x = "MPFC AVG") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

MPFC_AVG_plot3 <- ggplot(AllSubs_NeuralActivation, aes(x = (MPFC_avg_peak_pos), y = (All_Gross_M1_rank))) +
  labs(y = "Gross M1 Rank", x = "MPFC AVG") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

MPFC_AVG_plot4 <- ggplot(AllSubs_NeuralActivation, aes(x = (MPFC_avg_peak_pos), y = (GoT_M1_rank))) +
  labs(y = "Gross/Theaters M1 Rank", x = "MPFC AVG") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

plot_grid(MPFC_AVG_plot, MPFC_AVG_plot2, MPFC_AVG_plot3, MPFC_AVG_plot4, nrow=2)
```
...
NAcc_seg1_plot <- ggplot(AllSubs_NeuralActivation, aes(x = (NAcc_seg1), y = (All_Gross_M1_log))) +
  labs(y = "Gross M1 Log", x = "NAcc seg1") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_seg1_plot2 <- ggplot(AllSubs_NeuralActivation, aes(x = (NAcc_seg1), y = (GoT_M1))) +
  labs(y = "Gross/Theaters M1 Log", x = "NAcc seg1") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_seg1_plot3 <- ggplot(AllSubs_NeuralActivation, aes(x = (NAcc_seg1), y = (All_Gross_M1_rank))) +
  labs(y = "Gross M1 Rank", x = "NAcc seg1") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

NAcc_seg1_plot4 <- ggplot(AllSubs_NeuralActivation, aes(x = (NAcc_seg1), y = (GoT_M1_rank))) +
  labs(y = "Gross/Theaters M1 Rank", x = "NAcc seg1") + 
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)

plot_grid(NAcc_seg1_plot, NAcc_seg1_plot2, NAcc_seg1_plot3, NAcc_seg1_plot4, nrow=2)
```
...
Log_seq_models <- modelsummary(Log_seq_list, stars=TRUE, 
                               ...
                               #output="dataframe",
                               output = "Agg_sec_comedy_models.docx", 
...
Log_isc_models <- modelsummary(Log_isc_list, stars=TRUE, 
                               statistic = c("t = {statistic}", "s.e. = {std.error}"), 
                               output = "Agg_ISC_comedy_models.docx", 
                               gof_omit = "F|RMSE|Log") #%>% select(-part, -statistic)
Log_isc_models
```
...
Dem_pos_peak_models <- modelsummary(Dem_pos_peak_list, stars=TRUE, 
                                    statistic = c("t = {statistic}", "s.e. = {std.error}"),  
                                    output = "Agg_dem_comedy_models.docx", 
                                    #output="dataframe",
                                    gof_omit = "F|RMSE|Log") #%>% select(-part, -statistic)
Dem_pos_peak_models
```
...
```{r}
ggplot(AllSubs_NeuralActivation, aes(x = NAcc_dem_peak_pos_yes, y = (IMDb_rating))) +
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)
...
Dem_pos_peak_yes_models <- modelsummary(Dem_pos_peak_yes_list, stars=TRUE, 
                                        statistic = c("t = {statistic}", "s.e. = {std.error}"), 
                                        #output="dataframe",
                                        output = "Agg_dem_yes_comedy_models.docx", 
                                        gof_omit = "F|RMSE|Log") #%>% select(-part, -statistic)
...
Avg_pos_peak_models <- modelsummary(Avg_pos_peak_list, stars=TRUE, 
                                    statistic = c("t = {statistic}", "s.e. = {std.error}"), 
                                    output = "Agg_avg_comedy_models.docx", 
                                    gof_omit = "F|RMSE|Log") #%>% select(-part, -statistic)
Avg_pos_peak_models
```
...
Avg_pos_peak_yes_models <- modelsummary(Avg_pos_peak_yes_list, 
                                        statistic = c("t = {statistic}", "s.e. = {std.error}"),  
                                        output = "Agg_avg_yes_comedy_models.docx", 
                                        gof_omit = "F|RMSE|Log") #%>% select(-part, -statistic)
...
Avg_pos_peak2_models <- modelsummary(Avg_pos_peak2_list, stars=TRUE,
                                     statistic = c("t = {statistic}", "s.e. = {std.error}"), 
                                     output = "Agg_avg2_comedy_models.docx", 
                                     gof_omit = "F|RMSE|Log") #%>% select(-part, -statistic)
Avg_pos_peak2_models
```

```{r}
ggplot(AllSubs_NeuralActivation, aes(x = (NAcc_onset), y = (GoT_M1))) +
  geom_point() +
  geom_smooth(method = "lm") +
  stat_cor() +
  geom_text(aes(label = Trailer), vjust = 2)
...
Avg_pos_peak_yes2_models <- modelsummary(Avg_pos_peak_yes2_list, stars=TRUE, statistic=NULL, output = "dataframe", gof_omit = "F|RMSE|Log") %>% select(-part, -statistic)
