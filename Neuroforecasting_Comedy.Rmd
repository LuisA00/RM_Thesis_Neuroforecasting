...
```{r, echo = FALSE}
FW_US_M1 <- lm(scale(Gross_US_W2_num) ~ Theaters_US_W2_num 
         #+ Total_weeks 
...
```{r, echo = FALSE}
FW_US_M2 <- lm(scale(Gross_US_W4_num) ~  
              + Theaters_US_W4_num 
              + scale(NAcc_ISC) 
              + scale(AIns_ISC) 
              + scale(MPFC_ISC) 
...
```{r, echo = FALSE}
FW_US_M3 <- lm(scale(Gross_US_W1_num) ~  
             + Theaters_US_W1_num 
             #+ Total_weeks 
             #+ Weeks_avg_per_theater
             + scale(Pos_arousal_scaled) 
...
```{r, echo = FALSE}
GT_US_M1 <- lm(scale(Gross_Total_US) ~  
         + Total_Theaters_US 
         #+ Total_weeks 
         #+ Weeks_avg_per_theater
         + scale(Pos_arousal_scaled) 
...
```{r, echo = FALSE}
GT_US_M2 <- lm(scale(Gross_Total_US) ~ 
              + scale(NAcc_ISC) 
              + scale(AIns_ISC) 
              + scale(MPFC_ISC) 
...
```{r, echo = FALSE}
GT_US_M3 <- lm(scale(Gross_Total_US) ~  
             + Total_Theaters_US 
             #+ Total_weeks 
             #+ Weeks_avg_per_theater
             #+ scale(Pos_arousal_scaled) 
...
```{r, echo = FALSE}
GT_US_M4 <- lm(scale(Gross_Total_US) ~  
             + Total_Theaters_US 
             #+ Total_weeks 
             #+ Weeks_avg_per_theater
             + scale(NAcc_onset) 
...
```{r, echo = FALSE}
GT_US_M5 <- lm(scale(Gross_Total_US) ~  
              + Total_Theaters_US 
              #+ Total_weeks 
              #+ Weeks_avg_per_theater
              + scale(Pos_arousal_scaled) 
...
```{r, echo = FALSE}
GT_US_M6 <- lm(scale(Gross_Total_US) ~  
              + Total_Theaters_US 
              + Total_weeks 
              #+ Weeks_avg_per_theater
              + scale(NAcc_offset) 
...
```{r, echo = FALSE}
GT_US_M7 <- lm(scale(Gross_Total_US) ~  
              + Total_Theaters_US 
              #+ Total_weeks 
              #+ Weeks_avg_per_theater
              + scale(Pos_arousal_scaled) 
...
```{r, echo = FALSE}
GT_US_M8 <- lm(scale(Gross_Total_US) ~  
              + Total_Theaters_US 
              #+ Total_weeks 
              #+ Weeks_avg_per_theater
              + scale(NAcc_middle)  
...
```{r, echo = FALSE}
GT_US_M9 <- lm(scale(Gross_Total_US) ~  
              + Total_Theaters_US 
              + Total_weeks 
              #+ Weeks_avg_per_theater
              + scale(Pos_arousal_scaled) 
...
```{r, echo = FALSE}
GT_US_M10 <- lm(scale(Gross_Total_US) ~  
              + Total_Theaters_US 
              #+ Total_weeks 
              #+ Weeks_avg_per_theater
              + (NAcc_whole)  
...
```{r, echo = FALSE}
GT_US_M11 <- lm(scale(Gross_Total_US) ~  
              + Total_Theaters_US 
              #+ Total_weeks 
              #+ Weeks_avg_per_theater
              + scale(Pos_arousal_scaled) 
