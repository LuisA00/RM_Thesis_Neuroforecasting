...
```{r, echo = FALSE}
M6_H <- lmer(W_score~ scale(NAcc_onset) + scale(AIns_onset) + scale(MPFC_onset) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_H)
summary(M6_H)
r.squaredGLMM(M6_H)
```
...
```{r, echo = FALSE}
M6_C <- lmer(W_score~ scale(NAcc_onset) + scale(AIns_onset) + scale(MPFC_onset) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M6_C)
r.squaredGLMM(M6_C)
```
...
```{r, echo = FALSE}
M8_H <- lmer(W_score~ scale(NAcc_middle) + scale(AIns_middle) + scale(MPFC_middle) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_H)
summary(M8_H)
r.squaredGLMM(M8_H)
```
...
```{r, echo = FALSE}
M8_C <- lmer(W_score~ scale(NAcc_middle) + scale(AIns_middle) + scale(MPFC_middle) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M8_C)
r.squaredGLMM(M8_C)
```
...
```{r, echo = FALSE}
M9_H <- lmer(W_score~ scale(Pos_arousal) + scale(Neg_arousal) +  
...
```{r, echo = FALSE}
M9_C <- lmer(W_score~ scale(Pos_arousal) + scale(Neg_arousal) +  
             scale(NAcc_middle) + scale(AIns_middle) + scale(MPFC_middle) +
             (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M9_C)
r.squaredGLMM(M9_C)
...
```{r, echo = FALSE}
M10_H <- lmer(W_score~ scale(NAcc_offset) + scale(AIns_offset) + scale(MPFC_offset) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_H)
summary(M10_H)
r.squaredGLMM(M10_H)
```
...
```{r, echo = FALSE}
M10_C <- lmer(W_score~ scale(NAcc_offset) + scale(AIns_offset) + scale(MPFC_offset) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M10_C)
r.squaredGLMM(M10_C)
```
...
```{r, echo = FALSE}
M11_H <- lmer(W_score~ scale(Pos_arousal) + scale(Neg_arousal) +
...
```{r, echo = FALSE}
M11_C <- lmer(W_score~ scale(Pos_arousal) + scale(Neg_arousal) +
            scale(NAcc_offset) + scale(AIns_offset) + scale(MPFC_offset) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M11_C)
r.squaredGLMM(M11_C)
