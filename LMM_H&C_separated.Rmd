...
```{r, echo = FALSE}
M2_H <- lmer(W_score_scaled~ scale(NAcc_whole) + scale(AIns_whole) + scale(MPFC_whole) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_H)
summary(M2_H)
r.squaredGLMM(M2_H)
```
...
```{r, echo = FALSE}
M2_C <- lmer(W_score_scaled~ scale(NAcc_whole) + scale(AIns_whole) + scale(MPFC_whole) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M2_C)
r.squaredGLMM(M2_C)
```
...
```{r, echo = FALSE}
M3_H <- lmer(W_score_scaled~ scale(Pos_arousal_scaled) + scale(Neg_arousal_scaled) +  
...
```{r, echo = FALSE}
M3_C <- lmer(W_score_scaled~ scale(Pos_arousal_scaled) + scale(Neg_arousal_scaled) +  
             scale(NAcc_whole) + scale(AIns_whole) + scale(MPFC_whole) + 
             (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M3_C)
r.squaredGLMM(M3_C)
...
# M4_H: Neural ISC 
```{r, echo = FALSE}
M4_H <- lmer(W_score_scaled~ scale(NAcc_ISC) + scale(AIns_ISC) + scale(MPFC_ISC) +
             (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_H)
summary(M4_H)
r.squaredGLMM(M4_H)
```
# M4_C: Neural ISC 
```{r, echo = FALSE}
M4_C <- lmer(W_score_scaled~ scale(NAcc_ISC) + scale(AIns_ISC) + scale(MPFC_ISC) +
             (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M4_C)
r.squaredGLMM(M4_C)
```
...
```{r, echo = FALSE}
M5_H <- lmer(W_score_scaled~ scale(Pos_arousal_scaled) + scale(Neg_arousal_scaled) + 
...
```{r, echo = FALSE}
M5_C <- lmer(W_score_scaled~ scale(Pos_arousal) + scale(Neg_arousal) + 
             scale(NAcc_ISC) + scale(AIns_ISC) + scale(MPFC_ISC) +
             (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M5_C)
r.squaredGLMM(M5_C)
...
```{r, echo = FALSE}
M6_H <- lmer(W_score_scaled~ scale(NAcc_onset) + scale(AIns_onset) + scale(MPFC_onset) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_H)
summary(M6_H)
r.squaredGLMM(M6_H)
```
...
```{r, echo = FALSE}
M6_C <- lmer(W_score_scaled~ scale(NAcc_onset) + scale(AIns_onset) + scale(MPFC_onset) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M6_C)
r.squaredGLMM(M6_C)
```
...
```{r, echo = FALSE}
M7_H <- lmer(W_score_scaled~ scale(Pos_arousal_scaled) + scale(Neg_arousal_scaled) +  
...
```{r, echo = FALSE}
M7_C <- lmer(W_score_scaled~ scale(Pos_arousal_scaled) + scale(Neg_arousal_scaled) +  
             scale(NAcc_onset) + scale(AIns_onset) + scale(MPFC_onset) +
             (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M7_C)
r.squaredGLMM(M7_C)
...
```{r, echo = FALSE}
M8_H <- lmer(W_score_scaled~ scale(NAcc_middle) + scale(AIns_middle) + scale(MPFC_middle) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_H)
summary(M8_H)
r.squaredGLMM(M8_H)
```
...
```{r, echo = FALSE}
M8_C <- lmer(W_score_scaled~ scale(NAcc_middle) + scale(AIns_middle) + scale(MPFC_middle) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M8_C)
r.squaredGLMM(M8_C)
```
...
```{r, echo = FALSE}
M9_H <- lmer(W_score_scaled~ scale(Pos_arousal_scaled) + scale(Neg_arousal_scaled) +  
...
```{r, echo = FALSE}
M9_C <- lmer(W_score_scaled~ scale(Pos_arousal_scaled) + scale(Neg_arousal_scaled) +  
             scale(NAcc_middle) + scale(AIns_middle) + scale(MPFC_middle) +
             (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M9_C)
r.squaredGLMM(M9_C)
...
```{r, echo = FALSE}
M10_H <- lmer(W_score_scaled~ scale(NAcc_offset) + scale(AIns_offset) + scale(MPFC_offset) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_H)
summary(M10_H)
r.squaredGLMM(M10_H)
```
...
```{r, echo = FALSE}
M10_C <- lmer(W_score_scaled~ scale(NAcc_offset) + scale(AIns_offset) + scale(MPFC_offset) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M10_C)
r.squaredGLMM(M10_C)
```
...
```{r, echo = FALSE}
M11_H <- lmer(W_score_scaled~ scale(Pos_arousal_scaled) + scale(Neg_arousal_scaled) +
...
```{r, echo = FALSE}
M11_C <- lmer(W_score_scaled~ scale(Pos_arousal_scaled) + scale(Neg_arousal_scaled) +
            scale(NAcc_offset) + scale(AIns_offset) + scale(MPFC_offset) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M11_C)
r.squaredGLMM(M11_C)
...
```{r, echo = FALSE}
M13_H <- lmer(W_score_scaled~ scale(Pos_arousal_scaled) + scale(Neg_arousal_scaled) +
            scale(NAcc_pos_peak) + scale(AIns_pos_peak) + scale(MPFC_pos_peak) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_H)
summary(M13_H)
r.squaredGLMM(M13_H)
...
```{r, echo = FALSE}
M13_C <- lmer(W_score_scaled~ scale(Pos_arousal_scaled) + scale(Neg_arousal_scaled) +
            scale(NAcc_pos_peak) + scale(AIns_pos_peak) + scale(MPFC_pos_peak) +
            (1|Participant) + (1|Trailer), data = AllSubs_NeuralActivation_C)
summary(M13_C)
r.squaredGLMM(M13_C)
